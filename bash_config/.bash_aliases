...
ros2-base(){
  source ~/.local/opt/ros/jazzy_ws/install/setup.bash && PS1='(jazzy) ${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$' 
  if [ -f ~/.local/opt/ros/jazzy_ws_extras/install/local_setup.bash ]; then
    source ~/.local/opt/ros/jazzy_ws_extras/install/local_setup.bash
  fi
}
ros2-setup(){
