...
ros2-setup(){
  source ~/.local/opt/ros/jazzy_extras_ws/install/setup.bash && PS1='(jazzy) ${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ && source ~/ros2ws/install/local_setup.bash'
}
